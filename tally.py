...
def main() -> None:
    ...
    placements = [
        (by_label.get("1st"), by_label.get("count 1")),
        (by_label.get("2nd"), by_label.get("count 2")),
        (by_label.get("3rd"), by_label.get("count 3")),
        (by_label.get("4th"), by_label.get("count 4")),
    ]
    ...
    for col_idx in range(1, len(header)):
        ...
        if not title:
            continue
        results = []
        for name_row, count_row in placements:
